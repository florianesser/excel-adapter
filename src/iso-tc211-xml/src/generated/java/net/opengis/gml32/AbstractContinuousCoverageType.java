 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.AbstractContinuousCoverageType#getCoverageFunction <em>Coverage Function</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getAbstractContinuousCoverageType()
 * @model abstract="true"
...
public interface AbstractContinuousCoverageType extends AbstractCoverageType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractContinuousCoverageType_CoverageFunction()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractContinuousCoverageType#getCoverageFunction <em>Coverage Function</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
