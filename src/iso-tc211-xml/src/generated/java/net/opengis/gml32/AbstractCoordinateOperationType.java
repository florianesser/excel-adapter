 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getDomainOfValidity <em>Domain Of Validity</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getScope <em>Scope</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getOperationVersion <em>Operation Version</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getCoordinateOperationAccuracy <em>Coordinate Operation Accuracy</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getSourceCRS <em>Source CRS</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractCoordinateOperationType#getTargetCRS <em>Target CRS</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType()
 * @model abstract="true"
...
public interface AbstractCoordinateOperationType extends IdentifiedObjectType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_DomainOfValidity()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractCoordinateOperationType#getDomainOfValidity <em>Domain Of Validity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_Scope()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_OperationVersion()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractCoordinateOperationType#getOperationVersion <em>Operation Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link net.opengis.gml32.CoordinateOperationAccuracyType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_CoordinateOperationAccuracy()
	 * @model containment="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_SourceCRS()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractCoordinateOperationType#getSourceCRS <em>Source CRS</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractCoordinateOperationType_TargetCRS()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractCoordinateOperationType#getTargetCRS <em>Target CRS</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
