 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.AbstractDatumType#getDomainOfValidity <em>Domain Of Validity</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractDatumType#getScope <em>Scope</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractDatumType#getAnchorDefinitionGroup <em>Anchor Definition Group</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractDatumType#getAnchorDefinition <em>Anchor Definition</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType()
 * @model abstract="true"
...
public interface AbstractDatumType extends IdentifiedObjectType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType_DomainOfValidity()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractDatumType#getDomainOfValidity <em>Domain Of Validity</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType_Scope()
	...
	/**
	 * Returns the value of the '<em><b>Anchor Definition Group</b></em>' attribute list.
	 ...
	 * <!-- end-model-doc -->
	 * @return the value of the '<em>Anchor Definition Group</em>' attribute list.
	 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType_AnchorDefinitionGroup()
	 * @model dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="false"
	 *        extendedMetaData="kind='group' name='anchorDefinition:group' namespace='##targetNamespace'"
	 * @generated
	 */
	FeatureMap getAnchorDefinitionGroup();
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType_AnchorDefinition()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 *        extendedMetaData="kind='element' name='anchorDefinition' namespace='##targetNamespace' group='anchorDefinition:group'"
	 * @generated
	 */
	CodeType getAnchorDefinition();

	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractDatumType#getAnchorDefinition <em>Anchor Definition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractDatumType_RealizationEpoch()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractDatumType#getRealizationEpoch <em>Realization Epoch</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
