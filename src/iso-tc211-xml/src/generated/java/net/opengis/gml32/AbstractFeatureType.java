 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractFeatureType#getLocationGroup <em>Location Group</em>}</li>
 *   <li>{@link net.opengis.gml32.AbstractFeatureType#getLocation <em>Location</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getAbstractFeatureType()
 * @model abstract="true"
...
public interface AbstractFeatureType extends AbstractGMLType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractFeatureType_BoundedBy()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetBoundedBy()
	 * @see #getBoundedBy()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.AbstractFeatureType#getBoundedBy <em>Bounded By</em>}' containment reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractFeatureType_LocationGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getAbstractFeatureType_Location()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.AbstractFeatureType#getLocation <em>Location</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
