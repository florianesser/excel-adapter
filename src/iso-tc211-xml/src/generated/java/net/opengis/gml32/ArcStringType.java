 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.ArcStringType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml32.ArcStringType#getNumArc <em>Num Arc</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getArcStringType()
...
public interface ArcStringType extends AbstractCurveSegmentType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_Group()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_Pos()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_PointRep()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ArcStringType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_Coordinates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ArcStringType#getCoordinates <em>Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_Interpolation()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ArcStringType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.ArcStringType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInterpolation()
	 * @see #getInterpolation()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.ArcStringType#getInterpolation <em>Interpolation</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getArcStringType_NumArc()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ArcStringType#getNumArc <em>Num Arc</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
