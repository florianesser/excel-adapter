 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.ControlPointType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml32.ControlPointType#getGeometricPositionGroup <em>Geometric Position Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ControlPointType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.ControlPointType#getPointProperty <em>Point Property</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getControlPointType()
...
public interface ControlPointType extends EObject {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getControlPointType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ControlPointType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getControlPointType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
