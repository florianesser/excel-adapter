 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.ConversionType#getMethodGroup <em>Method Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ConversionType#getMethod <em>Method</em>}</li>
 *   <li>{@link net.opengis.gml32.ConversionType#getParameterValue <em>Parameter Value</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getConversionType()
...
public interface ConversionType extends AbstractGeneralConversionType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getConversionType_MethodGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getConversionType_Method()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ConversionType#getMethod <em>Method</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getConversionType_ParameterValue()
