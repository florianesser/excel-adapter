 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getVectorAtStart <em>Vector At Start</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getVectorAtEnd <em>Vector At End</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getDegree <em>Degree</em>}</li>
 *   <li>{@link net.opengis.gml32.CubicSplineType#getInterpolation <em>Interpolation</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getCubicSplineType()
...
public interface CubicSplineType extends AbstractCurveSegmentType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_Coordinates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getCoordinates <em>Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_VectorAtStart()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getVectorAtStart <em>Vector At Start</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_VectorAtEnd()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getVectorAtEnd <em>Vector At End</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_Degree()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getDegree <em>Degree</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.CubicSplineType#getDegree <em>Degree</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetDegree()
	 * @see #getDegree()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.CubicSplineType#getDegree <em>Degree</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getCubicSplineType_Interpolation()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.CubicSplineType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.CubicSplineType#getInterpolation <em>Interpolation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetInterpolation()
	 * @see #getInterpolation()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.CubicSplineType#getInterpolation <em>Interpolation</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
