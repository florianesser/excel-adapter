 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.DynamicFeatureType#getValidTime <em>Valid Time</em>}</li>
 *   <li>{@link net.opengis.gml32.DynamicFeatureType#getHistoryGroup <em>History Group</em>}</li>
 *   <li>{@link net.opengis.gml32.DynamicFeatureType#getHistory <em>History</em>}</li>
 *   <li>{@link net.opengis.gml32.DynamicFeatureType#getDataSource <em>Data Source</em>}</li>
 *   <li>{@link net.opengis.gml32.DynamicFeatureType#getDataSourceReference <em>Data Source Reference</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType()
...
public interface DynamicFeatureType extends AbstractFeatureType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType_ValidTime()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.DynamicFeatureType#getValidTime <em>Valid Time</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType_HistoryGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType_History()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.DynamicFeatureType#getHistory <em>History</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType_DataSource()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.DynamicFeatureType#getDataSource <em>Data Source</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getDynamicFeatureType_DataSourceReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.DynamicFeatureType#getDataSourceReference <em>Data Source Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
