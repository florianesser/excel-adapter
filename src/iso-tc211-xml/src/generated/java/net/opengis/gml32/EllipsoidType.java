 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.EllipsoidType#getSemiMajorAxis <em>Semi Major Axis</em>}</li>
 *   <li>{@link net.opengis.gml32.EllipsoidType#getSecondDefiningParameter <em>Second Defining Parameter</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getEllipsoidType()
...
public interface EllipsoidType extends IdentifiedObjectType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getEllipsoidType_SemiMajorAxis()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.EllipsoidType#getSemiMajorAxis <em>Semi Major Axis</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getEllipsoidType_SecondDefiningParameter()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.EllipsoidType#getSecondDefiningParameter <em>Second Defining Parameter</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
