 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.FaceType#getIsolated <em>Isolated</em>}</li>
 *   <li>{@link net.opengis.gml32.FaceType#getDirectedEdge <em>Directed Edge</em>}</li>
 *   <li>{@link net.opengis.gml32.FaceType#getDirectedTopoSolid <em>Directed Topo Solid</em>}</li>
 *   <li>{@link net.opengis.gml32.FaceType#getSurfaceProperty <em>Surface Property</em>}</li>
 *   <li>{@link net.opengis.gml32.FaceType#getAggregationType <em>Aggregation Type</em>}</li>
 *   <li>{@link net.opengis.gml32.FaceType#isUniversal <em>Universal</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getFaceType()
...
public interface FaceType extends AbstractTopoPrimitiveType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getFaceType_DirectedEdge()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getFaceType_DirectedTopoSolid()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getFaceType_SurfaceProperty()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.FaceType#getSurfaceProperty <em>Surface Property</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getFaceType_AggregationType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.FaceType#getAggregationType <em>Aggregation Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.FaceType#getAggregationType <em>Aggregation Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetAggregationType()
	 * @see #getAggregationType()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.FaceType#getAggregationType <em>Aggregation Type</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getFaceType_Universal()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.FaceType#isUniversal <em>Universal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.FaceType#isUniversal <em>Universal</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetUniversal()
	 * @see #isUniversal()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.FaceType#isUniversal <em>Universal</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
