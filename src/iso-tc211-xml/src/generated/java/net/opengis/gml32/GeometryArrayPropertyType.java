 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.GeometryArrayPropertyType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml32.GeometryArrayPropertyType#getAbstractGeometryGroup <em>Abstract Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml32.GeometryArrayPropertyType#getAbstractGeometry <em>Abstract Geometry</em>}</li>
 *   <li>{@link net.opengis.gml32.GeometryArrayPropertyType#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getGeometryArrayPropertyType()
...
public interface GeometryArrayPropertyType extends EObject {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getGeometryArrayPropertyType_Group()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getGeometryArrayPropertyType_AbstractGeometryGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getGeometryArrayPropertyType_AbstractGeometry()
	 ...
	 * @see #unsetOwns()
	 * @see #setOwns(boolean)
	 * @see net.opengis.gml32.GMLPackage#getGeometryArrayPropertyType_Owns()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.GeometryArrayPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.GeometryArrayPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetOwns()
	 * @see #isOwns()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.GeometryArrayPropertyType#isOwns <em>Owns</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
