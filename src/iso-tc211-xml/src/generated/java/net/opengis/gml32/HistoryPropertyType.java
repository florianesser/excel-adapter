 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.HistoryPropertyType#getAbstractTimeSliceGroup <em>Abstract Time Slice Group</em>}</li>
 *   <li>{@link net.opengis.gml32.HistoryPropertyType#getAbstractTimeSlice <em>Abstract Time Slice</em>}</li>
 *   <li>{@link net.opengis.gml32.HistoryPropertyType#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getHistoryPropertyType()
...
public interface HistoryPropertyType extends EObject {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getHistoryPropertyType_AbstractTimeSliceGroup()
	 ...
	 * The list contents are of type {@link net.opengis.gml32.AbstractTimeSliceType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * To describe an event — an action that occurs at an instant or over an interval of time — GML provides the gml:AbtractTimeSlice element. A timeslice encapsulates the time-varying properties of a dynamic feature -- it shall be extended to represent a time stamped projection of a specific feature. The gml:dataSource property describes how the temporal data was acquired.
	 ...
	 * @see net.opengis.gml32.GMLPackage#getHistoryPropertyType_AbstractTimeSlice()
	 ...
	 * @see #unsetOwns()
	 * @see #setOwns(boolean)
	 * @see net.opengis.gml32.GMLPackage#getHistoryPropertyType_Owns()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.HistoryPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.HistoryPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetOwns()
	 * @see #isOwns()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.HistoryPropertyType#isOwns <em>Owns</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
