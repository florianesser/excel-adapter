 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.LineStringType#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml32.LineStringType#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.LineStringType#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml32.LineStringType#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml32.LineStringType#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml32.LineStringType#getCoordinates <em>Coordinates</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getLineStringType()
...
public interface LineStringType extends AbstractCurveType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_Group()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_Pos()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_PointProperty()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_PointRep()
	 * @model containment="true" transient="true" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_PosList()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.LineStringType#getPosList <em>Pos List</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getLineStringType_Coordinates()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.LineStringType#getCoordinates <em>Coordinates</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
