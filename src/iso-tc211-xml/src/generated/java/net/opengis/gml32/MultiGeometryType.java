 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.MultiGeometryType#getGeometryMember <em>Geometry Member</em>}</li>
 *   <li>{@link net.opengis.gml32.MultiGeometryType#getGeometryMembers <em>Geometry Members</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getMultiGeometryType()
...
public interface MultiGeometryType extends AbstractGeometricAggregateType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getMultiGeometryType_GeometryMember()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getMultiGeometryType_GeometryMembers()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.MultiGeometryType#getGeometryMembers <em>Geometry Members</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
