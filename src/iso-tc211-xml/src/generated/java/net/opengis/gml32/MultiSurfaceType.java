 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.MultiSurfaceType#getSurfaceMember <em>Surface Member</em>}</li>
 *   <li>{@link net.opengis.gml32.MultiSurfaceType#getSurfaceMembers <em>Surface Members</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getMultiSurfaceType()
...
public interface MultiSurfaceType extends AbstractGeometricAggregateType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getMultiSurfaceType_SurfaceMember()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getMultiSurfaceType_SurfaceMembers()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.MultiSurfaceType#getSurfaceMembers <em>Surface Members</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
