 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.RangeSetType#getValueArray <em>Value Array</em>}</li>
 *   <li>{@link net.opengis.gml32.RangeSetType#getAbstractScalarValueListGroup <em>Abstract Scalar Value List Group</em>}</li>
 *   <li>{@link net.opengis.gml32.RangeSetType#getAbstractScalarValueList <em>Abstract Scalar Value List</em>}</li>
 *   <li>{@link net.opengis.gml32.RangeSetType#getDataBlock <em>Data Block</em>}</li>
 *   <li>{@link net.opengis.gml32.RangeSetType#getFile <em>File</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getRangeSetType()
...
public interface RangeSetType extends EObject {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRangeSetType_ValueArray()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRangeSetType_AbstractScalarValueListGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRangeSetType_AbstractScalarValueList()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRangeSetType_DataBlock()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.RangeSetType#getDataBlock <em>Data Block</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRangeSetType_File()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.RangeSetType#getFile <em>File</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
