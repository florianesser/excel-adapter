 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.RectifiedGridType#getOrigin <em>Origin</em>}</li>
 *   <li>{@link net.opengis.gml32.RectifiedGridType#getOffsetVector <em>Offset Vector</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getRectifiedGridType()
...
public interface RectifiedGridType extends GridType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getRectifiedGridType_Origin()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.RectifiedGridType#getOrigin <em>Origin</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
