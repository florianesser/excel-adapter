 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.UnitDefinitionType#getQuantityType <em>Quantity Type</em>}</li>
 *   <li>{@link net.opengis.gml32.UnitDefinitionType#getQuantityTypeReference <em>Quantity Type Reference</em>}</li>
 *   <li>{@link net.opengis.gml32.UnitDefinitionType#getCatalogSymbol <em>Catalog Symbol</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getUnitDefinitionType()
...
public interface UnitDefinitionType extends DefinitionType {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getUnitDefinitionType_QuantityType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.UnitDefinitionType#getQuantityType <em>Quantity Type</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getUnitDefinitionType_QuantityTypeReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.UnitDefinitionType#getQuantityTypeReference <em>Quantity Type Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.gml32.GMLPackage#getUnitDefinitionType_CatalogSymbol()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.UnitDefinitionType#getCatalogSymbol <em>Catalog Symbol</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
