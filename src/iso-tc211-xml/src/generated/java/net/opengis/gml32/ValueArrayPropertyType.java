 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractValueGroup <em>Abstract Value Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractValue <em>Abstract Value</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractGeometryGroup <em>Abstract Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractGeometry <em>Abstract Geometry</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractTimeObjectGroup <em>Abstract Time Object Group</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getAbstractTimeObject <em>Abstract Time Object</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#getNull <em>Null</em>}</li>
 *   <li>{@link net.opengis.gml32.ValueArrayPropertyType#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType()
...
public interface ValueArrayPropertyType extends EObject {
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractValueGroup()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractValue()
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractGeometryGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.gml32.AbstractGeometryType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * The AbstractGeometry element is the abstract head of the substitution group for all geometry elements of GML. This includes pre-defined and user-defined geometry elements. Any geometry element shall be a direct or indirect extension/restriction of AbstractGeometryType and shall be directly or indirectly in the substitution group of AbstractGeometry.
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractGeometry()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractTimeObjectGroup()
	 * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true" transient="true" volatile="true" derived="true"
	 ...
	 * The list contents are of type {@link net.opengis.gml32.AbstractTimeObjectType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 * gml:AbstractTimeObject acts as the head of a substitution group for all temporal primitives and complexes.
	 ...
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_AbstractTimeObject()
	 * @model containment="true" transient="true" changeable="false" volatile="true" derived="true"
	 ...
	 * @model unique="false" dataType="net.opengis.gml32.NilReasonType" transient="true" volatile="true" derived="true"
	 ...
	 * @see #unsetOwns()
	 * @see #setOwns(boolean)
	 * @see net.opengis.gml32.GMLPackage#getValueArrayPropertyType_Owns()
	...
	/**
	 * Sets the value of the '{@link net.opengis.gml32.ValueArrayPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.gml32.ValueArrayPropertyType#isOwns <em>Owns</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetOwns()
	 * @see #isOwns()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.gml32.ValueArrayPropertyType#isOwns <em>Owns</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
