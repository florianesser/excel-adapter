 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getDomainOfValidity <em>Domain Of Validity</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getScope <em>Scope</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getOperationVersion <em>Operation Version</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getCoordinateOperationAccuracy <em>Coordinate Operation Accuracy</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getSourceCRS <em>Source CRS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.AbstractCoordinateOperationTypeImpl#getTargetCRS <em>Target CRS</em>}</li>
 * </ul>
 *
 * @generated
 */
