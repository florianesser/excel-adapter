...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Geometric Aggregate Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.AbstractGeometricAggregateTypeImpl#getAggregationType <em>Aggregation Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractGeometricAggregateTypeImpl extends AbstractGeometryTypeImpl implements AbstractGeometricAggregateType {
	...
	public void setAggregationType(AggregationType newAggregationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.ABSTRACT_GEOMETRIC_AGGREGATE_TYPE__AGGREGATION_TYPE, oldAggregationType, aggregationType, !oldAggregationTypeESet));
	}
	...
	public void unsetAggregationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.ABSTRACT_GEOMETRIC_AGGREGATE_TYPE__AGGREGATION_TYPE, oldAggregationType, AGGREGATION_TYPE_EDEFAULT, oldAggregationTypeESet));
	}
