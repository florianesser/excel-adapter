...
import net.opengis.gml32.AbstractMetadataPropertyType;
...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Metadata Property Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.AbstractMetadataPropertyTypeImpl#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractMetadataPropertyTypeImpl extends MinimalEObjectImpl.Container implements AbstractMetadataPropertyType {
	...
	public void setOwns(boolean newOwns) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.ABSTRACT_METADATA_PROPERTY_TYPE__OWNS, oldOwns, owns, !oldOwnsESet));
	}
	...
	public void unsetOwns() {
		...
		ownsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.ABSTRACT_METADATA_PROPERTY_TYPE__OWNS, oldOwns, OWNS_EDEFAULT, oldOwnsESet));
	}
...
} //AbstractMetadataPropertyTypeImpl
