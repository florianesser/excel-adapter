 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.AbstractTimeGeometricPrimitiveTypeImpl#getFrame <em>Frame</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class AbstractTimeGeometricPrimitiveTypeImpl extends AbstractTimePrimitiveTypeImpl implements AbstractTimeGeometricPrimitiveType {
	...
	public void setFrame(String newFrame) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.ABSTRACT_TIME_GEOMETRIC_PRIMITIVE_TYPE__FRAME, oldFrame, frame, !oldFrameESet));
	}
	...
	public void unsetFrame() {
		...
		frameESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.ABSTRACT_TIME_GEOMETRIC_PRIMITIVE_TYPE__FRAME, oldFrame, FRAME_EDEFAULT, oldFrameESet));
	}
