...
import net.opengis.gml32.KnotPropertyType;
import net.opengis.gml32.KnotTypesType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getPointProperty <em>Point Property</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getPointRep <em>Point Rep</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getPosList <em>Pos List</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getDegree <em>Degree</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getKnot <em>Knot</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getInterpolation <em>Interpolation</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#isIsPolynomial <em>Is Polynomial</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.BSplineTypeImpl#getKnotType <em>Knot Type</em>}</li>
 * </ul>
 *
 * @generated
 */
