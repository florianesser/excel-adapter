 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.CompositeSurfaceTypeImpl#getSurfaceMember <em>Surface Member</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CompositeSurfaceTypeImpl#getAggregationType <em>Aggregation Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CompositeSurfaceTypeImpl extends AbstractSurfaceTypeImpl implements CompositeSurfaceType {
	...
	public void setAggregationType(AggregationType newAggregationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.COMPOSITE_SURFACE_TYPE__AGGREGATION_TYPE, oldAggregationType, aggregationType, !oldAggregationTypeESet));
	}
	...
	public void unsetAggregationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.COMPOSITE_SURFACE_TYPE__AGGREGATION_TYPE, oldAggregationType, AGGREGATION_TYPE_EDEFAULT, oldAggregationTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.COMPOSITE_SURFACE_TYPE__AGGREGATION_TYPE:
