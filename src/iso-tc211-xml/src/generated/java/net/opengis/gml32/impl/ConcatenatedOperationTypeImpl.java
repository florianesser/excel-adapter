 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.ConcatenatedOperationTypeImpl#getCoordOperationGroup <em>Coord Operation Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ConcatenatedOperationTypeImpl#getCoordOperation <em>Coord Operation</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ConcatenatedOperationTypeImpl#getAggregationType <em>Aggregation Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConcatenatedOperationTypeImpl extends AbstractCoordinateOperationTypeImpl implements ConcatenatedOperationType {
	 ...
	 */
	@Override
	public EList<CoordinateOperationPropertyType> getCoordOperation() {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case GMLPackage.CONCATENATED_OPERATION_TYPE__COORD_OPERATION:
				...
				getCoordOperation().addAll((Collection<? extends CoordinateOperationPropertyType>)newValue);
				return;
			case GMLPackage.CONCATENATED_OPERATION_TYPE__AGGREGATION_TYPE:
