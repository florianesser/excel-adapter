 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getAxisAbbrev <em>Axis Abbrev</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getAxisDirection <em>Axis Direction</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getMinimumValue <em>Minimum Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getMaximumValue <em>Maximum Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getRangeMeaning <em>Range Meaning</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.CoordinateSystemAxisTypeImpl#getUom <em>Uom</em>}</li>
 * </ul>
 *
 * @generated
 */
