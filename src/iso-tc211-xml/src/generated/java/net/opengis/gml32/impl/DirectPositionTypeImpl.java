 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.DirectPositionTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectPositionTypeImpl#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectPositionTypeImpl#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectPositionTypeImpl#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectPositionTypeImpl#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DirectPositionTypeImpl extends MinimalEObjectImpl.Container implements DirectPositionType {
	...
	protected EClass eStaticClass() {
		return GMLPackage.eINSTANCE.getDirectPositionType();
	}
	...
	public void setAxisLabels(List<String> newAxisLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECT_POSITION_TYPE__AXIS_LABELS, oldAxisLabels, axisLabels));
	}
	...
	public void setSrsDimension(BigInteger newSrsDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECT_POSITION_TYPE__SRS_DIMENSION, oldSrsDimension, srsDimension));
	}
	...
	public void setSrsName(String newSrsName) {
		...
		srsName = newSrsName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECT_POSITION_TYPE__SRS_NAME, oldSrsName, srsName));
	}
	...
	public void setUomLabels(List<String> newUomLabels) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECT_POSITION_TYPE__UOM_LABELS, oldUomLabels, uomLabels));
	}
