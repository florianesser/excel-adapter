 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getEdge <em>Edge</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getOrientation <em>Orientation</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectedEdgePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DirectedEdgePropertyTypeImpl extends MinimalEObjectImpl.Container implements DirectedEdgePropertyType {
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public void setOwns(boolean newOwns) {
		...
		ownsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__OWNS, oldOwns, owns, !oldOwnsESet));
	}
	...
	public void unsetOwns() {
		...
		ownsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__OWNS, oldOwns, OWNS_EDEFAULT, oldOwnsESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__HREF:
				return getHref();
			case GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__NIL_REASON:
				return getNilReason();
			case GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__ORIENTATION:
				return getOrientation();
			case GMLPackage.DIRECTED_EDGE_PROPERTY_TYPE__OWNS:
				return isOwns();
