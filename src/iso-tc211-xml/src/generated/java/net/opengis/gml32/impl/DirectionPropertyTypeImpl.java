...
import net.opengis.gml32.CompassPointEnumeration;
import net.opengis.gml32.DirectionDescriptionType;
import net.opengis.gml32.DirectionPropertyType;
import net.opengis.gml32.DirectionVectorType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getDirectionVector <em>Direction Vector</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getDirectionDescription <em>Direction Description</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getCompassPoint <em>Compass Point</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getDirectionKeyword <em>Direction Keyword</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getDirectionString <em>Direction String</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.DirectionPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
