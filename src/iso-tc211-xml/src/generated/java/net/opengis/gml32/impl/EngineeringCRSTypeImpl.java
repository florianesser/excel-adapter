 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getAffineCSGroup <em>Affine CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getAffineCS <em>Affine CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getCartesianCSGroup <em>Cartesian CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getCartesianCS <em>Cartesian CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getCylindricalCS <em>Cylindrical CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getLinearCS <em>Linear CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getPolarCS <em>Polar CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getSphericalCSGroup <em>Spherical CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getSphericalCS <em>Spherical CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getUserDefinedCS <em>User Defined CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getCoordinateSystemGroup <em>Coordinate System Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getCoordinateSystem <em>Coordinate System</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getEngineeringDatumGroup <em>Engineering Datum Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EngineeringCRSTypeImpl#getEngineeringDatum <em>Engineering Datum</em>}</li>
 * </ul>
 *
 * @generated
 */
