 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getLowerCorner <em>Lower Corner</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getUpperCorner <em>Upper Corner</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getCoordinates <em>Coordinates</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getAxisLabels <em>Axis Labels</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getSrsDimension <em>Srs Dimension</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getSrsName <em>Srs Name</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.EnvelopeTypeImpl#getUomLabels <em>Uom Labels</em>}</li>
 * </ul>
 *
 * @generated
 */
