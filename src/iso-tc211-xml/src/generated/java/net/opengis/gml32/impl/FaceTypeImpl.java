 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#getIsolated <em>Isolated</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#getDirectedEdge <em>Directed Edge</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#getDirectedTopoSolid <em>Directed Topo Solid</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#getSurfaceProperty <em>Surface Property</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#getAggregationType <em>Aggregation Type</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FaceTypeImpl#isUniversal <em>Universal</em>}</li>
 * </ul>
 *
 * @generated
 */
