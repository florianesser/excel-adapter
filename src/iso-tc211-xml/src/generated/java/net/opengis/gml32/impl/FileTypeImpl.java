 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getRangeParameters <em>Range Parameters</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getFileName <em>File Name</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getFileReference <em>File Reference</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getFileStructure <em>File Structure</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.FileTypeImpl#getCompression <em>Compression</em>}</li>
 * </ul>
 *
 * @generated
 */
