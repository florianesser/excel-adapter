 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getAbstractGeneralTransformationGroup <em>Abstract General Transformation Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getAbstractGeneralTransformation <em>Abstract General Transformation</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeneralTransformationPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
