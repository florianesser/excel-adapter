 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getEllipsoidalCSGroup <em>Ellipsoidal CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getEllipsoidalCS <em>Ellipsoidal CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getCartesianCSGroup <em>Cartesian CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getCartesianCS <em>Cartesian CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getSphericalCSGroup <em>Spherical CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getSphericalCS <em>Spherical CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getGeodeticDatumGroup <em>Geodetic Datum Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeodeticCRSTypeImpl#getGeodeticDatum <em>Geodetic Datum</em>}</li>
 * </ul>
 *
 * @generated
 */
