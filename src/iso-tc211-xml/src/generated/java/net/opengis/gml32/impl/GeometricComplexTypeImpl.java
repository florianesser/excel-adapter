 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.GeometricComplexTypeImpl#getElement <em>Element</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GeometricComplexTypeImpl#getAggregationType <em>Aggregation Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeometricComplexTypeImpl extends AbstractGeometryTypeImpl implements GeometricComplexType {
	...
	protected EClass eStaticClass() {
		return GMLPackage.eINSTANCE.getGeometricComplexType();
	}
	...
	public EList<GeometricPrimitivePropertyType> getElement() {
		if (element == null) {
			element = new EObjectContainmentEList<GeometricPrimitivePropertyType>(GeometricPrimitivePropertyType.class, this, GMLPackage.GEOMETRIC_COMPLEX_TYPE__ELEMENT);
		}
		return element;
	}
	...
	public void setAggregationType(AggregationType newAggregationType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.GEOMETRIC_COMPLEX_TYPE__AGGREGATION_TYPE, oldAggregationType, aggregationType, !oldAggregationTypeESet));
	}
	...
	public void unsetAggregationType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.GEOMETRIC_COMPLEX_TYPE__AGGREGATION_TYPE, oldAggregationType, AGGREGATION_TYPE_EDEFAULT, oldAggregationTypeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GMLPackage.GEOMETRIC_COMPLEX_TYPE__ELEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GMLPackage.GEOMETRIC_COMPLEX_TYPE__ELEMENT:
				return getElement();
			case GMLPackage.GEOMETRIC_COMPLEX_TYPE__AGGREGATION_TYPE:
