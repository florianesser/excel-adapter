...
import net.opengis.gml32.SequenceRuleType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.GridFunctionTypeImpl#getSequenceRule <em>Sequence Rule</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.GridFunctionTypeImpl#getStartPoint <em>Start Point</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GridFunctionTypeImpl extends MinimalEObjectImpl.Container implements GridFunctionType {
	...
	public void setSequenceRule(SequenceRuleType newSequenceRule) {
		if (newSequenceRule != sequenceRule) {
			...
			if (newSequenceRule != null)
				msgs = ((InternalEObject)newSequenceRule).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.GRID_FUNCTION_TYPE__SEQUENCE_RULE, null, msgs);
			msgs = basicSetSequenceRule(newSequenceRule, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.GRID_FUNCTION_TYPE__SEQUENCE_RULE, newSequenceRule, newSequenceRule));
	}
	...
	public void setStartPoint(List<BigInteger> newStartPoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.GRID_FUNCTION_TYPE__START_POINT, oldStartPoint, startPoint));
	}
