 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getCartesianCSGroup <em>Cartesian CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getCartesianCS <em>Cartesian CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getAffineCSGroup <em>Affine CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getAffineCS <em>Affine CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getUsesObliqueCartesianCS <em>Uses Oblique Cartesian CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getImageDatumGroup <em>Image Datum Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ImageCRSTypeImpl#getImageDatum <em>Image Datum</em>}</li>
 * </ul>
 *
 * @generated
 */
