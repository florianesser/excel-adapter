 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getAbstractMetaDataGroup <em>Abstract Meta Data Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getAbstractMetaData <em>Abstract Meta Data</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getAbout <em>About</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MetaDataPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MetaDataPropertyTypeImpl extends MinimalEObjectImpl.Container implements MetaDataPropertyType {
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.META_DATA_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.META_DATA_PROPERTY_TYPE__HREF:
				return getHref();
			case GMLPackage.META_DATA_PROPERTY_TYPE__NIL_REASON:
				return getNilReason();
