 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getPos <em>Pos</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getLocationName <em>Location Name</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getLocationReference <em>Location Reference</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getLocationGroup <em>Location Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getSpeed <em>Speed</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getBearing <em>Bearing</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getAcceleration <em>Acceleration</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getElevation <em>Elevation</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MovingObjectStatusTypeImpl#getStatusReference <em>Status Reference</em>}</li>
 * </ul>
 *
 * @generated
 */
