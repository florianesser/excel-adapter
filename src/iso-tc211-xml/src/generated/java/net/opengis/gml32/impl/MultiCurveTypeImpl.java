 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.MultiCurveTypeImpl#getCurveMember <em>Curve Member</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.MultiCurveTypeImpl#getCurveMembers <em>Curve Members</em>}</li>
 * </ul>
 *
 * @generated
 */
	...
	public void setCurveMembers(CurveArrayPropertyType newCurveMembers) {
		if (newCurveMembers != curveMembers) {
			...
			if (newCurveMembers != null)
				msgs = ((InternalEObject)newCurveMembers).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.MULTI_CURVE_TYPE__CURVE_MEMBERS, null, msgs);
			msgs = basicSetCurveMembers(newCurveMembers, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.MULTI_CURVE_TYPE__CURVE_MEMBERS, newCurveMembers, newCurveMembers));
	}
