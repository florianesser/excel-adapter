 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.ObservationTypeImpl#getValidTime <em>Valid Time</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ObservationTypeImpl#getUsing <em>Using</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ObservationTypeImpl#getTargetGroup <em>Target Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ObservationTypeImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ObservationTypeImpl#getResultOf <em>Result Of</em>}</li>
 * </ul>
 *
 * @generated
 */
