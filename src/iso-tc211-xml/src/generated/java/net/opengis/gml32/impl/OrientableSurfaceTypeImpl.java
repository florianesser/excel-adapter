 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.OrientableSurfaceTypeImpl#getBaseSurface <em>Base Surface</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.OrientableSurfaceTypeImpl#getOrientation <em>Orientation</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrientableSurfaceTypeImpl extends AbstractSurfaceTypeImpl implements OrientableSurfaceType {
	...
	public void setBaseSurface(SurfacePropertyType newBaseSurface) {
		if (newBaseSurface != baseSurface) {
			...
			if (newBaseSurface != null)
				msgs = ((InternalEObject)newBaseSurface).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.ORIENTABLE_SURFACE_TYPE__BASE_SURFACE, null, msgs);
			msgs = basicSetBaseSurface(newBaseSurface, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.ORIENTABLE_SURFACE_TYPE__BASE_SURFACE, newBaseSurface, newBaseSurface));
	}
	...
	public void setOrientation(SignType newOrientation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.ORIENTABLE_SURFACE_TYPE__ORIENTATION, oldOrientation, orientation, !oldOrientationESet));
	}
	...
	public void unsetOrientation() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.ORIENTABLE_SURFACE_TYPE__ORIENTATION, oldOrientation, ORIENTATION_EDEFAULT, oldOrientationESet));
	}
