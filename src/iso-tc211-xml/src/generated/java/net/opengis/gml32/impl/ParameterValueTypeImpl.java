 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getDmsAngleValue <em>Dms Angle Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getStringValue <em>String Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getIntegerValue <em>Integer Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#isBooleanValue <em>Boolean Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getValueList <em>Value List</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getIntegerValueList <em>Integer Value List</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getValueFile <em>Value File</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getOperationParameterGroup <em>Operation Parameter Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ParameterValueTypeImpl#getOperationParameter <em>Operation Parameter</em>}</li>
 * </ul>
 *
 * @generated
 */
