 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.RangeSetTypeImpl#getValueArray <em>Value Array</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.RangeSetTypeImpl#getAbstractScalarValueListGroup <em>Abstract Scalar Value List Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.RangeSetTypeImpl#getAbstractScalarValueList <em>Abstract Scalar Value List</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.RangeSetTypeImpl#getDataBlock <em>Data Block</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.RangeSetTypeImpl#getFile <em>File</em>}</li>
 * </ul>
 *
 * @generated
 */
