...
import net.opengis.gml32.RelativePositionType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.RelatedTimeTypeImpl#getRelativePosition <em>Relative Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelatedTimeTypeImpl extends TimePrimitivePropertyTypeImpl implements RelatedTimeType {
	...
	public void setRelativePosition(RelativePositionType newRelativePosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.RELATED_TIME_TYPE__RELATIVE_POSITION, oldRelativePosition, relativePosition, !oldRelativePositionESet));
	}
	...
	public void unsetRelativePosition() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.RELATED_TIME_TYPE__RELATIVE_POSITION, oldRelativePosition, RELATIVE_POSITION_EDEFAULT, oldRelativePositionESet));
	}
