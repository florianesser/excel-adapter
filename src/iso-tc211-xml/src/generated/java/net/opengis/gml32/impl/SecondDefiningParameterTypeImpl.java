 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.SecondDefiningParameterTypeImpl#getInverseFlattening <em>Inverse Flattening</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SecondDefiningParameterTypeImpl#getSemiMinorAxis <em>Semi Minor Axis</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SecondDefiningParameterTypeImpl#isIsSphere <em>Is Sphere</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SecondDefiningParameterTypeImpl extends MinimalEObjectImpl.Container implements SecondDefiningParameterType {
	...
	public void setInverseFlattening(MeasureType newInverseFlattening) {
		if (newInverseFlattening != inverseFlattening) {
			...
			if (newInverseFlattening != null)
				msgs = ((InternalEObject)newInverseFlattening).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__INVERSE_FLATTENING, null, msgs);
			msgs = basicSetInverseFlattening(newInverseFlattening, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__INVERSE_FLATTENING, newInverseFlattening, newInverseFlattening));
	}
	...
	public void setSemiMinorAxis(LengthType newSemiMinorAxis) {
		if (newSemiMinorAxis != semiMinorAxis) {
			...
			if (newSemiMinorAxis != null)
				msgs = ((InternalEObject)newSemiMinorAxis).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__SEMI_MINOR_AXIS, null, msgs);
			msgs = basicSetSemiMinorAxis(newSemiMinorAxis, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__SEMI_MINOR_AXIS, newSemiMinorAxis, newSemiMinorAxis));
	}
	...
	public void setIsSphere(boolean newIsSphere) {
		...
		isSphereESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__IS_SPHERE, oldIsSphere, isSphere, !oldIsSphereESet));
	}
	...
	public void unsetIsSphere() {
		...
		isSphereESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__IS_SPHERE, oldIsSphere, IS_SPHERE_EDEFAULT, oldIsSphereESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.SECOND_DEFINING_PARAMETER_TYPE__IS_SPHERE:
				return isIsSphere();
		}
