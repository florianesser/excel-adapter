 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.SphereTypeImpl#getHorizontalCurveType <em>Horizontal Curve Type</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SphereTypeImpl#getVerticalCurveType <em>Vertical Curve Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SphereTypeImpl extends AbstractGriddedSurfaceTypeImpl implements SphereType {
	...
	protected EClass eStaticClass() {
		return GMLPackage.eINSTANCE.getSphereType();
	}
	...
	public void setHorizontalCurveType(CurveInterpolationType newHorizontalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SPHERE_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, horizontalCurveType, !oldHorizontalCurveTypeESet));
	}
	...
	public void unsetHorizontalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.SPHERE_TYPE__HORIZONTAL_CURVE_TYPE, oldHorizontalCurveType, HORIZONTAL_CURVE_TYPE_EDEFAULT, oldHorizontalCurveTypeESet));
	}
	...
	public void setVerticalCurveType(CurveInterpolationType newVerticalCurveType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SPHERE_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, verticalCurveType, !oldVerticalCurveTypeESet));
	}
	...
	public void unsetVerticalCurveType() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.SPHERE_TYPE__VERTICAL_CURVE_TYPE, oldVerticalCurveType, VERTICAL_CURVE_TYPE_EDEFAULT, oldVerticalCurveTypeESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GMLPackage.SPHERE_TYPE__HORIZONTAL_CURVE_TYPE:
				return getHorizontalCurveType();
			case GMLPackage.SPHERE_TYPE__VERTICAL_CURVE_TYPE:
