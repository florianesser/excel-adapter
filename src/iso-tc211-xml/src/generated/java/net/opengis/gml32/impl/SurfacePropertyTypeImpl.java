 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getAbstractSurfaceGroup <em>Abstract Surface Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getAbstractSurface <em>Abstract Surface</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.SurfacePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SurfacePropertyTypeImpl extends MinimalEObjectImpl.Container implements SurfacePropertyType {
	/**
	 * The cached value of the '{@link #getAbstractSurfaceGroup() <em>Abstract Surface Group</em>}' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAbstractSurfaceGroup()
	 * @generated
	 * @ordered
	 */
	protected FeatureMap abstractSurfaceGroup;
	...
	public FeatureMap getAbstractSurfaceGroup() {
		if (abstractSurfaceGroup == null) {
			abstractSurfaceGroup = new BasicFeatureMap(this, GMLPackage.SURFACE_PROPERTY_TYPE__ABSTRACT_SURFACE_GROUP);
		}
		return abstractSurfaceGroup;
	}
	...
	public AbstractSurfaceType getAbstractSurface() {
		return (AbstractSurfaceType)getAbstractSurfaceGroup().get(GMLPackage.eINSTANCE.getSurfacePropertyType_AbstractSurface(), true);
	}
	...
	public NotificationChain basicSetAbstractSurface(AbstractSurfaceType newAbstractSurface, NotificationChain msgs) {
		return ((FeatureMap.Internal)getAbstractSurfaceGroup()).basicAdd(GMLPackage.eINSTANCE.getSurfacePropertyType_AbstractSurface(), newAbstractSurface, msgs);
	}
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SURFACE_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public void setOwns(boolean newOwns) {
		...
		ownsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.SURFACE_PROPERTY_TYPE__OWNS, oldOwns, owns, !oldOwnsESet));
	}
	...
	public void unsetOwns() {
		...
		ownsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.SURFACE_PROPERTY_TYPE__OWNS, oldOwns, OWNS_EDEFAULT, oldOwnsESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GMLPackage.SURFACE_PROPERTY_TYPE__ABSTRACT_SURFACE_GROUP:
				return ((InternalEList<?>)getAbstractSurfaceGroup()).basicRemove(otherEnd, msgs);
			case GMLPackage.SURFACE_PROPERTY_TYPE__ABSTRACT_SURFACE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.SURFACE_PROPERTY_TYPE__HREF:
				return getHref();
			case GMLPackage.SURFACE_PROPERTY_TYPE__NIL_REASON:
				return getNilReason();
			case GMLPackage.SURFACE_PROPERTY_TYPE__OWNS:
				return isOwns();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case GMLPackage.SURFACE_PROPERTY_TYPE__ABSTRACT_SURFACE_GROUP:
				return abstractSurfaceGroup != null && !abstractSurfaceGroup.isEmpty();
			case GMLPackage.SURFACE_PROPERTY_TYPE__ABSTRACT_SURFACE:
	...
	public String toString() {
		...
		result.append(" (abstractSurfaceGroup: ");
		result.append(abstractSurfaceGroup);
