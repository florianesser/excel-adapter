...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Target Property Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getAbstractFeatureGroup <em>Abstract Feature Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getAbstractFeature <em>Abstract Feature</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getAbstractGeometryGroup <em>Abstract Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getAbstractGeometry <em>Abstract Geometry</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TargetPropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TargetPropertyTypeImpl extends MinimalEObjectImpl.Container implements TargetPropertyType {
	...
	public void setActuate(ActuateType newActuate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__ACTUATE, oldActuate, actuate, !oldActuateESet));
	}
	...
	public void unsetActuate() {
		...
		actuateESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.TARGET_PROPERTY_TYPE__ACTUATE, oldActuate, ACTUATE_EDEFAULT, oldActuateESet));
	}
	...
	public void setArcrole(String newArcrole) {
		...
		arcrole = newArcrole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__ARCROLE, oldArcrole, arcrole));
	}
	...
	public void setHref(String newHref) {
		...
		href = newHref;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__HREF, oldHref, href));
	}
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public void setOwns(boolean newOwns) {
		...
		ownsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__OWNS, oldOwns, owns, !oldOwnsESet));
	}
	...
	public void unsetOwns() {
		...
		ownsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.TARGET_PROPERTY_TYPE__OWNS, oldOwns, OWNS_EDEFAULT, oldOwnsESet));
	}
	...
	public void setRemoteSchema(String newRemoteSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__REMOTE_SCHEMA, oldRemoteSchema, remoteSchema));
	}
	...
	public void setRole(String newRole) {
		...
		role = newRole;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__ROLE, oldRole, role));
	}
	...
	public void setShow(ShowType newShow) {
		...
		showESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__SHOW, oldShow, show, !oldShowESet));
	}
	...
	public void unsetShow() {
		...
		showESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.TARGET_PROPERTY_TYPE__SHOW, oldShow, SHOW_EDEFAULT, oldShowESet));
	}
	...
	public void setTitle(String newTitle) {
		...
		title = newTitle;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__TITLE, oldTitle, title));
	}
	...
	public void setType(TypeType newType) {
		...
		typeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TARGET_PROPERTY_TYPE__TYPE, oldType, type, !oldTypeESet));
	}
	...
	public void unsetType() {
		...
		typeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.TARGET_PROPERTY_TYPE__TYPE, oldType, TYPE_EDEFAULT, oldTypeESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GMLPackage.TARGET_PROPERTY_TYPE__ABSTRACT_GEOMETRY_GROUP:
				return ((InternalEList<?>)getAbstractGeometryGroup()).basicRemove(otherEnd, msgs);
			case GMLPackage.TARGET_PROPERTY_TYPE__ABSTRACT_GEOMETRY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case GMLPackage.TARGET_PROPERTY_TYPE__ACTUATE:
				return getActuate();
			case GMLPackage.TARGET_PROPERTY_TYPE__ARCROLE:
				return getArcrole();
			case GMLPackage.TARGET_PROPERTY_TYPE__HREF:
				return getHref();
			case GMLPackage.TARGET_PROPERTY_TYPE__NIL_REASON:
				return getNilReason();
			case GMLPackage.TARGET_PROPERTY_TYPE__OWNS:
				return isOwns();
			case GMLPackage.TARGET_PROPERTY_TYPE__REMOTE_SCHEMA:
				return getRemoteSchema();
			case GMLPackage.TARGET_PROPERTY_TYPE__ROLE:
				return getRole();
			case GMLPackage.TARGET_PROPERTY_TYPE__SHOW:
				return getShow();
			case GMLPackage.TARGET_PROPERTY_TYPE__TITLE:
				return getTitle();
			case GMLPackage.TARGET_PROPERTY_TYPE__TYPE:
				return getType();
		}
