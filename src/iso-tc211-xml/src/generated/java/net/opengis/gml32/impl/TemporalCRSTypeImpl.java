 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.TemporalCRSTypeImpl#getTimeCSGroup <em>Time CS Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TemporalCRSTypeImpl#getTimeCS <em>Time CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TemporalCRSTypeImpl#getUsesTemporalCS <em>Uses Temporal CS</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TemporalCRSTypeImpl#getTemporalDatumGroup <em>Temporal Datum Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TemporalCRSTypeImpl#getTemporalDatum <em>Temporal Datum</em>}</li>
 * </ul>
 *
 * @generated
 */
