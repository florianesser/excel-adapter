 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.TimeNodeTypeImpl#getPreviousEdge <em>Previous Edge</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeNodeTypeImpl#getNextEdge <em>Next Edge</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeNodeTypeImpl#getPosition <em>Position</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeNodeTypeImpl extends AbstractTimeTopologyPrimitiveTypeImpl implements TimeNodeType {
	...
	public void setPosition(TimeInstantPropertyType newPosition) {
		if (newPosition != position) {
			...
			if (newPosition != null)
				msgs = ((InternalEObject)newPosition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GMLPackage.TIME_NODE_TYPE__POSITION, null, msgs);
			msgs = basicSetPosition(newPosition, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TIME_NODE_TYPE__POSITION, newPosition, newPosition));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case GMLPackage.TIME_NODE_TYPE__POSITION:
