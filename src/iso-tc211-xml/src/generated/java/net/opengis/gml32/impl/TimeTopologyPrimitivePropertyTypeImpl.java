...
import net.opengis.gml32.TimeTopologyPrimitivePropertyType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getAbstractTimeTopologyPrimitiveGroup <em>Abstract Time Topology Primitive Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getAbstractTimeTopologyPrimitive <em>Abstract Time Topology Primitive</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getActuate <em>Actuate</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getArcrole <em>Arcrole</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#isOwns <em>Owns</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getRemoteSchema <em>Remote Schema</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getRole <em>Role</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getShow <em>Show</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TimeTopologyPrimitivePropertyTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TimeTopologyPrimitivePropertyTypeImpl extends MinimalEObjectImpl.Container implements TimeTopologyPrimitivePropertyType {
	/**
	 * The cached value of the '{@link #getAbstractTimeTopologyPrimitiveGroup() <em>Abstract Time Topology Primitive Group</em>}' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getAbstractTimeTopologyPrimitiveGroup()
	 * @generated
	 * @ordered
	 */
	protected FeatureMap abstractTimeTopologyPrimitiveGroup;
	 ...
	 */
	@Override
	public FeatureMap getAbstractTimeTopologyPrimitiveGroup() {
		if (abstractTimeTopologyPrimitiveGroup == null) {
			abstractTimeTopologyPrimitiveGroup = new BasicFeatureMap(this, GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP);
		}
		return abstractTimeTopologyPrimitiveGroup;
	}
	...
	public AbstractTimeTopologyPrimitiveType getAbstractTimeTopologyPrimitive() {
		return (AbstractTimeTopologyPrimitiveType)getAbstractTimeTopologyPrimitiveGroup().get(GMLPackage.eINSTANCE.getTimeTopologyPrimitivePropertyType_AbstractTimeTopologyPrimitive(), true);
	}
	...
	public NotificationChain basicSetAbstractTimeTopologyPrimitive(AbstractTimeTopologyPrimitiveType newAbstractTimeTopologyPrimitive, NotificationChain msgs) {
		return ((FeatureMap.Internal)getAbstractTimeTopologyPrimitiveGroup()).basicAdd(GMLPackage.eINSTANCE.getTimeTopologyPrimitivePropertyType_AbstractTimeTopologyPrimitive(), newAbstractTimeTopologyPrimitive, msgs);
	}
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
	...
	public void setOwns(boolean newOwns) {
		...
		ownsESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__OWNS, oldOwns, owns, !oldOwnsESet));
	}
	...
	public void unsetOwns() {
		...
		ownsESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__OWNS, oldOwns, OWNS_EDEFAULT, oldOwnsESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP:
				return ((InternalEList<?>)getAbstractTimeTopologyPrimitiveGroup()).basicRemove(otherEnd, msgs);
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP:
				if (coreType) return getAbstractTimeTopologyPrimitiveGroup();
				return ((FeatureMap.Internal)getAbstractTimeTopologyPrimitiveGroup()).getWrapper();
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE:
			...
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__HREF:
				return getHref();
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__NIL_REASON:
				return getNilReason();
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__OWNS:
				return isOwns();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP:
				((FeatureMap.Internal)getAbstractTimeTopologyPrimitiveGroup()).set(newValue);
				return;
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ACTUATE:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP:
				getAbstractTimeTopologyPrimitiveGroup().clear();
				return;
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ACTUATE:
				unsetActuate();
				return;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE_GROUP:
				return abstractTimeTopologyPrimitiveGroup != null && !abstractTimeTopologyPrimitiveGroup.isEmpty();
			case GMLPackage.TIME_TOPOLOGY_PRIMITIVE_PROPERTY_TYPE__ABSTRACT_TIME_TOPOLOGY_PRIMITIVE:
	...
	public String toString() {
		...
		result.append(" (abstractTimeTopologyPrimitiveGroup: ");
		result.append(abstractTimeTopologyPrimitiveGroup);
