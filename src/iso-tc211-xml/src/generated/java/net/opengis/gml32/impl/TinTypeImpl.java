...
import net.opengis.gml32.ControlPointType;
import net.opengis.gml32.GMLPackage;
import net.opengis.gml32.LengthType;
import net.opengis.gml32.LineStringSegmentArrayPropertyType;
 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.TinTypeImpl#getStopLines <em>Stop Lines</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TinTypeImpl#getBreakLines <em>Break Lines</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TinTypeImpl#getMaxLength <em>Max Length</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.TinTypeImpl#getControlPoint <em>Control Point</em>}</li>
 * </ul>
 *
 * @generated
 */
