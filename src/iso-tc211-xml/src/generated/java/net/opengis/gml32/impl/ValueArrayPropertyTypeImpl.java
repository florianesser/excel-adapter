 ...
 * </p>
 * <ul>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractValueGroup <em>Abstract Value Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractValue <em>Abstract Value</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractGeometryGroup <em>Abstract Geometry Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractGeometry <em>Abstract Geometry</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractTimeObjectGroup <em>Abstract Time Object Group</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getAbstractTimeObject <em>Abstract Time Object</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#getNull <em>Null</em>}</li>
 *   <li>{@link net.opengis.gml32.impl.ValueArrayPropertyTypeImpl#isOwns <em>Owns</em>}</li>
 * </ul>
 *
 * @generated
 */
