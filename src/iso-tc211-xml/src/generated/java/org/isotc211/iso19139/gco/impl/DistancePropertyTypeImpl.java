...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Distance Property Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.isotc211.iso19139.gco.impl.DistancePropertyTypeImpl#getDistance <em>Distance</em>}</li>
 *   <li>{@link org.isotc211.iso19139.gco.impl.DistancePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DistancePropertyTypeImpl extends MinimalEObjectImpl.Container implements DistancePropertyType {
	...
	public void setDistance(LengthType newDistance) {
		if (newDistance != distance) {
			...
			if (newDistance != null)
				msgs = ((InternalEObject)newDistance).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GCOPackage.DISTANCE_PROPERTY_TYPE__DISTANCE, null, msgs);
			msgs = basicSetDistance(newDistance, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GCOPackage.DISTANCE_PROPERTY_TYPE__DISTANCE, newDistance, newDistance));
	}
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GCOPackage.DISTANCE_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
