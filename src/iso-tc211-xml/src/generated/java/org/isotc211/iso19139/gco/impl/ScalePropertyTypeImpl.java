...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Scale Property Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.isotc211.iso19139.gco.impl.ScalePropertyTypeImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link org.isotc211.iso19139.gco.impl.ScalePropertyTypeImpl#getNilReason <em>Nil Reason</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ScalePropertyTypeImpl extends MinimalEObjectImpl.Container implements ScalePropertyType {
	...
	public void setScale(ScaleType newScale) {
		if (newScale != scale) {
			...
			if (newScale != null)
				msgs = ((InternalEObject)newScale).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GCOPackage.SCALE_PROPERTY_TYPE__SCALE, null, msgs);
			msgs = basicSetScale(newScale, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GCOPackage.SCALE_PROPERTY_TYPE__SCALE, newScale, newScale));
	}
	...
	public void setNilReason(Object newNilReason) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GCOPackage.SCALE_PROPERTY_TYPE__NIL_REASON, oldNilReason, nilReason));
	}
